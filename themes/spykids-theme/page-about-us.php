...
<div class="main-content">
    ...
    <section class="members">
        <h1>The niggas who made the website</h1>
        <div class="row">
            <div class="BasicColumn">
                <img src="./images/user 1.jpeg" class="niggas">
                <h1> Ocean</h1>    
            </div>
            <div class="BasicColumn">
                <img src="./images/user 1.jpeg" class="niggas">
    ...
    <!-- the niggas who update the news website -->
    <section class="members">
        <h1>The niggas who update the news website</h1>
        <div class="row">
            <div class="BasicColumn">
                <img src="./images/user 1.jpeg" class="niggas">
                <h1> Raeya</h1>
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            <div class="text">
                ...
                <span></span>
                <h2>Image overlay</h2>
                <p>stuff about random cool stuff i dont know cool stuff</p>
            </div>
        </div>
